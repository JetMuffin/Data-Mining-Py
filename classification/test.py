...
dataset1_train_matrix, dataset1_train_label = load_matrix_label_from_txt(dataset2_train_txt)
dataset1_test_matrix, dataset1_test_label = load_matrix_label_from_txt(dataset2_test_txt)
